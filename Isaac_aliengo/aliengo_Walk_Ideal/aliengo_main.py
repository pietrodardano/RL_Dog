"""
    ...
    ./isaaclab.sh -p /home/user/Documents/RL_Dog/Isaac_aliengo/aliengo_Walk_Ideal/aliengo_main.py --num_envs 2048 --headless --enable_cameras
...
import argparse
parser = argparse.ArgumentParser(description='Aliengo_Walk_Ideal Env Config')
...
parser.add_argument("--task",           type=str,       default="Aliengo_Walk_Ideal",  help="Name of the task.")

parser.add_argument("--my_headless",       action="store_true",    default=True,    help="GUI or not GUI.")
parser.add_argument("--video",          action="store_true",    default=True,    help="Record videos during training.")
parser.add_argument("--video_length",   type=int,               default=600,     help="Length of the recorded video (in steps).")
parser.add_argument("--video_interval", type=int,               default=16000,   help="Interval between video recordings (in steps).")
...
def main():
    ...
    agent.train_sequential(timesteps=35000, headless=args_cli.my_headless)
    env.close()
