...
class SceneCfg(InteractiveSceneCfg):
    ...
    # Robot
    robot: ArticulationCfg = AliengoCFG_Black.replace(prim_path="{ENV_REGEX_NS}/Robot_a")
    
    # SENSORS (virtual ones, the real robot does not has them)
    contact_forces = ContactSensorCfg(prim_path="{ENV_REGEX_NS}/Robot_a/.*", history_length=3, track_air_time=True)
    ...
    light = AssetBaseCfg(
                ...
                init_state=AssetBaseCfg.InitialStateCfg(pos=(0.0, 0.0, 550.0)),
            )
