"""
    ...
    ./isaaclab.sh -p /home/user/Documents/RL_Dog/Isaac_aliengo/aliengo_Stop_FullState_2/aliengo_main.py --num_envs 1028 --headless --enable_cameras
...
import argparse
parser = argparse.ArgumentParser(description='AlienGo_S_FS Env Config')
