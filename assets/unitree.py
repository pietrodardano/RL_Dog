...
"""
              ...
              !-- NOTE THAT THIS FILE SERVES ONLY AS EXAMPLE AND REFERENCE  --!

        To actually change the configuration of the robot, you should modify the corresponding
        file in the source of IsaacLab at path: /home/$USER$/IsaacLab/source/isaaclab_assets/isaaclab_assets/robots/unitree.py
...
AliengoCFG_Black = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/user/Documents/RL_Dog/assets/USD/aliengo_black.usd", # or user/Documents/GitHub
    ...
    actuators={
        "base_legs": DCMotorCfg(
            joint_names_expr=[".*_hip_joint", ".*_thigh_joint", ".*_calf_joint"],
            effort_limit=35.5,	    # original = 33.5
            saturation_effort=35.5, # original = 33.5
