...
AliengoCFG_Black = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/rl_sim/IsaacLab_/source/extensions/omni.isaac.lab_assets/data/Robots/Unitree/aliengo_black.usd", # in future modify it with Nucleus directory 
...
AliengoCFG_Color = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/rl_sim/IsaacLab_/source/extensions/omni.isaac.lab_assets/data/Robots/Unitree/aliengo_color.usd", # in future modify it with Nucleus directory 
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
################################################################ ORIGINALLY PROVIDED BY ISAACLAB
